...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<Object> handleAllCategoryAlreadyRegisteredException (CategoryAlreadyRegistered ex, WebRequest request) {
    ...
    public final ResponseEntity<Object> handleAllInvalidCategoryOrFieldIdException (InvalidCategoryOrFieldIdException ex, WebRequest request) {
