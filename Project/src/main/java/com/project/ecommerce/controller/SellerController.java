...
public class SellerController {
    ...
    public String addSeller(@RequestBody Seller seller,@RequestHeader(name = "Accept-Language", required = false) Locale locale) {
    ...
    public String editSeller(@RequestBody SellerDto seller,@RequestHeader(name = "Accept-Language", required = false) Locale locale){
