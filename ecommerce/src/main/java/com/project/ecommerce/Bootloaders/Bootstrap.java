...
import com.project.ecommerce.repositries.OrderRepository;
import com.project.ecommerce.repositries.ProductRepository;
import com.project.ecommerce.repositries.RoleRepository;
...
public class Bootstrap implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        //saving the customer
        Customer customer1 = new Customer("ritik@mru", "Ritik", "", "Mehta", "9728405565");
        customer1.setPassword(passwordEncoder.encode("Ritik#1020"));

        Customer customer2 = new Customer("muskan@niift", "Muskan", "", "Arora", "7015317584");
        ...
        //saving the seller;
        Seller seller1 = new Seller("seller1@123", "seller1", "", "", "gst1", "seller1_company", 250840);
        seller1.setPassword(passwordEncoder.encode("Seller@1"));


        Seller seller2 = new Seller("seller2@123", "seller2", "", "", "gst2", "seller2_company", 250841);
        ...
        Admin admin2=new Admin("admin@tothenew","Admin","","Admin");
