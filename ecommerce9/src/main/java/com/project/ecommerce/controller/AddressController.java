...
public class AddressController {
    ...
    public String addCustomerAddress(@RequestBody Address address,
        ...
        addressService.addCustomerAddress(address,locale);
    ...
    public String updateCustomerAddress(@Valid @RequestBody Address address,
                                        @PathVariable Long addressId,
                                        @RequestHeader(name = "Accept-Language",
                                                required = false)Locale locale){
        addressService.updateCustomerAddress(address,addressId,locale);
    ...
    public String deleteCustomerAddress(@Valid @PathVariable Long addressId,
                                        @RequestHeader(name = "Accept-Language",
                                                required = false) Locale locale){
        addressService.deleteCustomerAddress(addressId,locale);
    ...
    public String updateSellerAddress(@PathVariable Long addId,
                                      @RequestBody Address address,
                                      @RequestHeader(name = "Accept-Language",
                                              required = false) Locale locale){
        addressService.updateSellerAddress(address,addId,locale);
