...
public class AddressController {
    ...
    public String addCustomerAddress
            (@RequestBody Address address,@RequestHeader
    ...
    public String updateCustomerAddress
            (@Valid @RequestBody Address address, @PathVariable Long AddressId,@RequestHeader
                    (name = "Accept-Language", required = false)Locale locale){
    ...
    public String deleteCustomerAddress
            (@Valid @PathVariable Long addressId,@RequestHeader
                    (name = "Accept-Language", required = false) Locale locale){
    ...
    public String updateSellerAddress
            (@PathVariable Long addId, @RequestBody Address address,@RequestHeader
                    (name = "Accept-Language", required = false) Locale locale){
